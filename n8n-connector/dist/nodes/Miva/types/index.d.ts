...
export type MivaOperation = 'getProducts' | 'getOrders' | 'getCustomers' | 'adjustInventory' | 'reportLowInventory' | 'createReturns' | 'createShipment' | 'updateShipments' | 'markReturnsReceived' | 'uploadImages' | 'deleteProductImage' | 'acknowledgeOrders' | 'updateProduct' | 'insertProduct';
